...
export function TileLayout({ chatOpen }: TileLayoutProps) {
  ...
  const hasSecondTile = !VOICE_FIRST_LAYOUT && (isCameraEnabled || isScreenShareEnabled);
            ...
            <AnimatePresence mode="popLayout">
              {!isAvatar && (
                ...
                <MotionContainer
                  ...
                  className={cn(
                    'bg-background aspect-square h-22.5 rounded-md border border-transparent transition-[border,drop-shadow]',
